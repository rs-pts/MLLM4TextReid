...
if __name__ == '__main__':
    ...
    # trainset ,train_loader,  val_img_loader2, val_txt_loader2, num_classes = build_zero_shot_loader(args)
    ...
    if args.nam:
        ...
        # do_pretrain(start_epoch, args, model, train_loader, evaluator2, optimizer, scheduler, checkpointer, trainset)
    else:
        # do_train(start_epoch, args, model, train_loader, evaluator0,evaluator1,evaluator2, optimizer, scheduler, checkpointer, trainset)
        do_train(start_epoch, args, model, train_loader,evaluator2, optimizer, scheduler, checkpointer, trainset)
